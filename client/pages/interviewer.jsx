...
export default class interviewer extends Component {
    ...
    goToDone = () => {
        Router.push("/done?interviewId=" + this.props.interviewId + "&intervieweeId=" + this.props.interviweeId);
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Button variant="outlined" color="secondary" onClick={() => this.goToDone()}>Go back to done page</Button>
            </div>
        );
    }
}
