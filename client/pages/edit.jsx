...
export default class EditFormPage extends Component {
  static async getInitialProps({ query }) {
    const intervieweeInfo = await fetch("http://localhost:8080/interviewee/" + query.intervieweeId, {
        method: "GET"
    }).then(response => {
  ...
  editInterviewee = () => {
    ...
    const intervieweePromise = fetch("http://localhost:8080/interviewee/" + this.props.intervieweeId, {
      method: "PUT",
      headers: {
