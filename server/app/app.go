...
func (app *App) setupHandlers() {
	...
	app.Router.HandleFunc("/intervieweecreate", app.IntervieweeCreateUser).Methods("POST")
	app.Router.HandleFunc("/intervieweeupdate/{id}", app.IntervieweeUpdateInfo).Methods("POST")
